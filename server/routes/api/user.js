...
router.post('/profiles/:username/follow', checkToken, UserController.follow);
router.delete('/profiles/:username/follow', checkToken, UserController.unfollow);
router.get('/followings', checkToken, UserController.following);
